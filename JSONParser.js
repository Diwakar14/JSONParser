...
function getDataTypeOfObject(dataObject, container) {
    ...
    keys.forEach((key) => {
      if (typeof dataObject[key] == "object") {
        if (dataObject[key]?.length == undefined) {
          //   console.log("Object");
          if (dataObject[key]) {
            getDataTypeOfObject(dataObject[key], container);
          } else {
            // console.log("Null");
          }
        } else {
          //   console.log("array");
          let newCont = { key: key, type: "array", values: [] };
          dataObject[key].forEach((item) => {
            if (typeof item === "object")
              getDataTypeOfObject(item, newCont.values);
          });
          container.push(newCont);
        }
      } else if (typeof dataObject[key] == "number") {
        //console.info("number", dataObject, key);
        container.push({ key: key, type: "number", value: dataObject[key] });
      } else {
        //console.info("string");

        container.push({ key: key, type: "string", value: dataObject[key] });
      }
    });
  }
}
...
var container = [];
getDataTypeOfObject(data, container);
